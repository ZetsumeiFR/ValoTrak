export const en = {
	...
	contractProgress: "{{xp}} XP into the next level",
	leaderboardRank: "Leaderboard",
	leaderboardOf: "of {{total}} ranked players",
	topTierCutoff: "Top tier cutoff",
	topTierCutoffSub: "rating to hold the top tier",
	topAgents: "Top agents",
	recentMatches: "Recent matches",
	friendsOnline: "Friends in game",
	stateMenus: "In menus",
	statePregame: "Agent select",
	stateInGame: "In game",
	partySize: "party {{size}}/{{max}}",
...
export const fr = {
	...
	contractLevel: "Niveau de contrat",
	contractProgress: "{{xp}} XP vers le niveau suivant",
	leaderboardRank: "Classement",
	leaderboardOf: "sur {{total}} joueurs classés",
	topTierCutoff: "Seuil du palier max",
	topTierCutoffSub: "points requis pour tenir le palier",
	topAgents: "Meilleurs agents",
	recentMatches: "Matchs récents",
	friendsOnline: "Amis en jeu",
	stateMenus: "Dans les menus",
	statePregame: "Sélection d'agent",
	stateInGame: "En partie",
	partySize: "groupe {{size}}/{{max}}",
